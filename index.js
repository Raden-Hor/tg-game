...
const TOKEN = "5415236570:AAH9t3DPIilMzHPapG5g4ZeGeFT9nDJGycc";
const server = express();
const bot = new TelegramBot(TOKEN, { polling: true });

const gameName = "tos_pherk";
...
bot.on("callback_query", function (query) {
    if (query.game_short_name !== gameName) {
        ...
        let gameurl = "https://tg-game-bitbot.herokuapp.com/index.html?id=" + query.id;
